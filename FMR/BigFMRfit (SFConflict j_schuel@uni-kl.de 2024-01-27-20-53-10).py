...
def main():
    ...
    # KittelPlot(frequency, H, H_err, g_fit, Ms_fit, Hani_fit_dict, angle=180, save=False)

    # alpha_fit, dHinhomo_fit_dict, alpha_error, dHinhomo_error_dict = LinewidthFit(frequency, dHres)
    # LinewidthPlot(frequency, dHres, dHres_err, alpha_fit, dHinhomo_fit_dict, angle=180, save=False)
...
def LinewidthPlot(frequency, dHres, dHres_err, alpha_fit, dHinhomo_fit_dict, angle=0, show=True, save=False):
    ...
    mygraph.plot_Graph(save=save, show=show, legend=False, xlabel='$f$\u2009(GHz)', ylabel='$\mu_0\Delta H_\mathrm{res}$\u2009(mT)', name=f'dHresPlot{angle}')
...
def KittelPlot(frequency, H, H_err, g_fit, Ms_fit, Hani_fit_dict, angle=0, save=False):
    ...
    mygraph.plot_Graph(save=save, legend=None, xlabel='$\mu_0 H_0$\u2009(T)', ylabel='$f$\u2009(GHz)', name=f'KittelPlot{angle}')
