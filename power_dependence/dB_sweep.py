...
input_folder = r'C:\Users\Julian\Documents\BA\Power_Sweep#3'
...
def main():
    ...
    # GraphPlot(unique_powers, deltaS12_values, save=False, xlabel='P in dB', ylabel='$\Delta S12$ in dB', name=f'{name}_DeltaDB')
    ...
    mygraph.plot_Graph(save=False, legend=False, xlabel='$\mu_0 H$ in T', ylabel='$S12$ in dB', name=f'{name}_dBplot', outputfolder=output_folder)
